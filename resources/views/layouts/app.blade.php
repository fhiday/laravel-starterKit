...
<head>
    ...
    <title>Auth - FH Admin Dashboard</title>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>
                    {{ ucwords(str_replace(['_', '.'], ' ', request()->route()->getName())) }} Management
                </h3>
                <p class="text-subtitle text-muted"> Kelolah halaman ini dengan bijaksana. </p>
            </div>
